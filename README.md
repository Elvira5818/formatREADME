...
После рассмотрения данной главы хотелось бы предоставить Вам отрывок из знаменитого произведения:
...
Узнали? Да? Ну тогда давайте продолжим по теме занятия.
Итак следующая глава у нас:
